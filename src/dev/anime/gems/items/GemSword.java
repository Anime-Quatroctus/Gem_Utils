...
public class GemSword extends ItemSword implements ICustomModel {

	private static final String[] types = new String[] { "ruby" };
	
	private final ToolMaterial toolMaterial;
	
	public GemSword(ToolMaterial material) {
		super(material);
		this.toolMaterial = material;
		this.setRegistryName("gem_sword");
	...
	public void handleModelLocations() {
		...
		for (int i = 0; i < locations.length; i++) locations[i] = new ResourceLocation(Main.MODID, types[i] + "_sword");
